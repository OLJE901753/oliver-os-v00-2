...
import { SelfReviewService, QualityGateService, ImprovementSuggestionsService,
...
export class SmartAssistanceExample {
     ...
     * Smart suggestions
     */
    async generateSuggestions(filePath) {
    ...
    async suggestRefactoring(filePath) {
        ...
        try {
            ...
            const refactoringSuggestions = suggestions.filter(s => s.type === 'maintainability' || s.type === 'best-practices' || s.type === 'architecture');
     ...
     * Smart quality check
     */
    async checkQuality(projectPath) {
     ...
     */
    async rollbackChanges(backupPath, _targetPath) {
...
//# sourceMappingURL=smart-assistance-example.js.map